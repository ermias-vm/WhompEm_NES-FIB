...
public:
    ...
    // Nueva función para modificar showBossHP
    void setShowBossHP(bool show) { showBossHP = show; }

private:
    bool showBossHPFlag = false;

private:
    int playerHP, playerLifes, bossHP;
    bool godMode, is_H_pressed, is_G_pressed, is_B_pressed, showBossHP;
